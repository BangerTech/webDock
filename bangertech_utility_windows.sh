...
INSTALL_TYPE=$(whiptail --backtitle "The BangerTECH Utility WINDOWS VERSION" --title "SELECT INSTALLATION TYPE" --menu "Choose your installation type" 15 60 2 \
...
case $INSTALL_TYPE in
    ...
    "1")
        sleep 5
        CHOICES=$(whiptail --backtitle "The BangerTECH Utility WINDOWS VERSION" --title "SELECT PACKAGES TO INSTALL" --checklist "Choose options" 29 85 22 \
